# ambient障害について<br>
<h4>オフィシャルにはアナウンスされていませんが、現在アクセスできない状況のようです。<br>
FBのユーザーグループでは、「2026年7月29日14時頃、Ambientサーバーを管理するアカウントが不正アクセスされ、現在もサーバーの再起動ができません。」との書き込みがあります。
mimamoriPico、sensorPicoとも装置としては正常に動作しますが、Web表示についてはambientに依存しているため表示できない状況です。<br>
状況が分かり次第、こちらでも情報提供しますが、当方としては復旧を待つほかない状況です。<br>
</h4>
...
2025/12/13 ファームウェア(RPI_PICO_W-20251209-v1.27.0.uf2)　で動作確認<br>
2026/05/18 ファームウェア(RPI_PICO_W-20260406-v1.28.0.uf2)　で動作確認<br>
